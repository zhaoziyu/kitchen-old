...
public class KitEncryptionPBKDF2 {
     ...
     */
    public static Pair<String, String> encryptByRandomSalt(String content) throws InvalidKeySpecException, NoSuchAlgorithmException {
        byte[] randomSalt = getRandomSalt();

        byte[] ciphertext = pbkdf2(content.toCharArray(), randomSalt, PBKDF2_ITERATIONS, HASH_BYTES);
     ...
     * @return
     */
    public static Pair<String, String> encryptByFixSalt(String content, String saltHex) throws InvalidKeySpecException, NoSuchAlgorithmException {
        byte[] bSalt = fromHex(saltHex);
        byte[] ciphertext = pbkdf2(content.toCharArray(), bSalt, PBKDF2_ITERATIONS, HASH_BYTES);
