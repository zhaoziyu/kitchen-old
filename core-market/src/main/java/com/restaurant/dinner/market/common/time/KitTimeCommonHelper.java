...
public class KitTimeCommonHelper {
    ...
    public static Pair<Date, Date> getTodayRange() {
        ...
        LocalDateTime todayBegin = LocalDateTime.parse(todayDate + " 00:00:01", KitTimeFormatter.getFormatter(KitTimeFormatter.YYYYsMMsDD_HHsMMsSS));
        LocalDateTime todayEnd = LocalDateTime.parse(todayDate + " 23:59:59", KitTimeFormatter.getFormatter(KitTimeFormatter.YYYYsMMsDD_HHsMMsSS));

        Date startDate = Date.from(todayBegin.atZone(ZoneId.systemDefault()).toInstant());
